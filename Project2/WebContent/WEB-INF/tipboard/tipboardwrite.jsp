...
<form name="tipwrite" action="tipboardwriteok.tb" method ="POST">
	<!-- BEGIN card -->
	<div class="card">
		...
		<div class="card-footer" id="write-button">
			<div class="text-left"><button type="submit" class="btn btn-primary ml-auto" id="saveBtn">Save</button>&nbsp;</div>
			<div class="text-left"><button type="button" class="btn btn-secondary" id="cancelBtn" onclick="location.href='tipboard.tb'">Cancel</button></div>
		</div>
		<!-- END card-footer -->
	</div>
