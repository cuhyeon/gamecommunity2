...
<!-- 콘텐츠 영역 시작-->
<form name="qawrite" action="qawriteeditok.qb?id=${requestScope.result.id}" method="POST">
	<div class="row text-center">
		<div class="col-1"></div>
			<div class="col-10">
				<h5>수정하기${requestScope.result.id}</h5>
				<hr>
			</div>
		<div class="col-1"></div>
	</div>
	...
	<div class="row">
		...
		<div class="col-10">
			<div class="form-group">
			  <input type="text" class="form-control" id="title" name="title" placeholder="글 제목을 입력해 주세요" value="${requestScope.result.title }">
			</div>
		</div>
		<div class="col-1"></div>
	</div>
