...
<div class="row justify-content-md-center">
	<form id="news-write-form" action="deleteboardok.nb?id=${dto.id}" enctype="multipart/form-data" method="post">
			...
			<table>
				<tr>
					...
					<td><input type="text" class="form-control" name="title"
						id="title" placeholder="제목을 입력하세요" value="${dto.title}" readonly></td>
				</tr>
			</table>
		...
		<div class="row justify-content-md-left">
			<div class="col_c">
				<div class="input-group">
					...
					<textarea class="form-control" name="editor1" readonly>${dto.content}</textarea>
				</div>
			</div>
		</div>
